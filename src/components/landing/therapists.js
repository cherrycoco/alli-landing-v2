      ...
      <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            ...
            <p className="mt-6 text-xl leading-8 text-gray-600">Our therapists come from diverse backgrounds and bring a wide range of experience to the table. From our talented Residents, to our skillful Intermediate and Advanced professionals, each member of our team is highly qualified and trained in a variety of therapy techniques.</p>
