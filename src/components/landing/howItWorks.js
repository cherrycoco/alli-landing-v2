          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            ...
            <dt className="gap-x-3 text-base font-semibold leading-7 text-gray-900">
              ...
              <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                <p className="flex-auto">Whether you work with our Residents, Intermediate, or Advanced Therapists, you get to choose a session rate that suits your budget within the given therapist's given range.</p>
                <p className="mt-6">
