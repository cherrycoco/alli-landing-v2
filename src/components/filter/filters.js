...
const Filters = ({ specialization, setSpecialization, modality, setModality, tier, setTier, clear }) => {
  ...
  return (
    <div className="flex justify-end mt-12">
      ...
      {open && <div className="flex w-11/12 m-auto flex-col space-y-2 sm:space-y-0 sm:space-x-4 sm:flex-row">
        ...
        <SpecializationFilter onChange={val => setSpecialization(val)} selected={specialization} />
        <ModalityFilter onChange={val => setModality(val)} selected={modality} />
